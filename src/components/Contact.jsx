      ...
      <section className="bg-white font-semibold ">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          ...
          <form action="#" className="space-y-8">
            ...
            <button
              type="submit"
              className="py-3 px-5 text-sm font-medium text-center hover:text-white rounded-lg bg-gray-50 sm:w-fit hover:bg-pink-600 border p-3 shadow-md hover:shadow-pink-400 "
            >
              Send Message
            </button>
          </form>
