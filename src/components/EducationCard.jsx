  ...
  return (
    <div className=" bg-white rounded-lg flex flex-col md:flex-row overflow-hidden shadow-lg">
      <img
        src={image}
        alt={title}
        className="w-full md:w-1/3 h-48 md:h-auto object-cover education-card p-5 rounded-lg"
      />
      ...
      <div className="p-4 flex items-center justify-center md:justify-start">
        <Link
          to="/contact"
          className="text-pink-500 hover:text-white bg-gray-100 resumeColor font-semibold p-3 border-transparent shadow-lg rounded-md border header-button flex sm:items-start "
        >
          Contact Me
        </Link>
      </div>
