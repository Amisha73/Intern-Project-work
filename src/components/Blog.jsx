  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      <div className="text-center mb-8">
        <p className="text-center text-[16px] text-pink-600 uppercase">Visit My Blog and Keep Your Feedback</p>
        <h1 className="text-center text-[30px] font-bold text-gray-700 sm:text-[60px]">My Blog</h1>
      </div>
